...
class TransformerEncoder(FairseqEncoder):
    ...
    def __init__(self, args, dictionary, embed_tokens):
        ...
        pre = torch.zeros(300)
        m = etm.ETM(50, 33556, 800, 300, 300,'relu', pre, 1, 0.0).cuda()
        ...
        with open('/cache/code_dir/vocab.pkl', 'rb') as f:
            self.vo = pickle.load(f)

        self.vocab = []
        f = open('/cache/data_dir/bin/dict.en.txt')
...
@register_model_architecture("ENC_post", "ENC_post")
