#修改位置：第362-382行，第443-474行，第692-714行，第883-908行
import math
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False):
        ...
        self.vocab = []
        f = open('/cache/data_dir/dict.fr.txt')
...
@register_model_architecture("ENC_post_DEC", "ENC_post_DEC")
