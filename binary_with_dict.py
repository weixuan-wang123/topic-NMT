...
cmd = ["bash", script, src_lang, tgt_lang, args.train_prefix, args.dev_prefix, args.test_prefix,args.true_case_model, args.vocab_src, args.vocab_tgt,args.bpe_code]
...
mox.file.copy_parallel(
    os.path.join(LOCAL_DIR, "model_dir"),
    model_dir)
if not mox.file.exists(model_dir + "data/"):
    #     mox.file.remove(args.model_dir, recursive=True)
    mox.file.make_dirs(model_dir + "data/")
mox.file.copy_parallel(
