...
cmd = ["bash", script, src_lang, tgt_lang, args.test_prefix,args.true_case_model, args.vocab_src, args.vocab_tgt,args.bpe_code, args.checkpoint]
...
# copy back to s3
data_set = os.path.join(args.train_url,args.data_set+"_Test")
